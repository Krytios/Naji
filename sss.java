...
public class Java_Insert_Update_Delete_Display extends javax.swing.JFrame {
 ...
 // get a list of users from mysql database
   public ArrayList<Employe> getEmployesList()
   {
       ...
       try {
           ...
           while(rs.next())
           {
               employe = new User(rs.getInt("id"),rs.getString("fname"),rs.getString("lname"),rs.getInt("age"),rs.getInt("salaire"));
   ...
   public void Show_Employes_In_JTable()
   {
       ArrayList<Employe> list = getEmployesList();
       DefaultTableModel model = (DefaultTableModel)jTable_Display_Employes.getModel();
   ...
   public void executeSQlQuery(String query, String message)
   {
    ...
    private void initComponents() {
        ...
        jTable_Display_Employes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "First Name", "Last Name", "Age", "Salaire"
            }
        ));
        jTable_Display_Employes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTable_Display_EmployesMouseClicked(evt);
            }
        });
    ...
    private void jTextField_SalaireActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

 // show jtable row data in jtextfields in the mouse clicked event
    private void jTable_Display_EmployesMouseClicked(java.awt.event.MouseEvent evt) {                                                  
       // Get The Index Of The Slected Row 
        int i = jTable_Display_Employes.getSelectedRow();

        TableModel model = jTable_Display_Employes.getModel();
        ...
        jTextField_Salaire.setText(model.getValueAt(i,4).toString());
    }                                                 

 // Button Insert
    private void jButton_InsertActionPerformed(java.awt.event.ActionEvent evt) {                                               
        String query = "INSERT INTO `employes`(`nom`, `prenom`, `age`, `salaire`) VALUES ('"+jTextField_Nom.getText()+"','"+jTextField_Prenom.getText()+"',"+jTextField_Age.getText()+"',"+jTextField_Salaire.getText()+")";
 ...
 // Button Update
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {                                               
       String query = "UPDATE `employes` SET `nom`='"+jTextField_Nom.getText()+"',`prenom`='"+jTextField_Prenom.getText()+"',`age`="+jTextField_Age.getText()+"',`salaire`="+jTextField_Salaire.getText()+" WHERE `id` = "+jTextField_Id.getText();
 ...
 // Button Delete
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {                                               
        String query = "DELETE FROM `employes` WHERE id = "+jTextField_Id.getText();
